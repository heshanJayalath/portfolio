    ...
    mx-auto'>
      ...
      flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <span className='text-[#915eff]'> Malinga</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I develop User Interfaces,<br className='sm:block hidden'/> Mobile Applications and web Applications.
          </p>
        </div>
      ...
      items-center'>
          <a href='#about'>
            ...
            flex justify-center items-center items-start p-2'>
              <motion.dev
                animate = {{
                  y:[0,24,0]
                }}
